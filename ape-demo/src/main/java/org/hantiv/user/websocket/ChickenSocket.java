package org.hantiv.user.websocket;

import lombok.extern.slf4j.Slf4j;
import org.hantiv.websocket.config.WebSocketServerConfig;
...
/**
 * @Author Zhikun Han
 * @Date Created in 21:28 2022/12/2
 * @Description:
 */
@Component
...
public class ChickenSocket {
     ...
     */
    @OnOpen
    public void onOpen(Session session, EndpointConfig conf) throws Exception {
        //获取用户信息
        try {
